...
namespace  RtclElb\DiviModule\Store\StoreName;
use Rtcl\Helpers\Functions;
use Rtcl\Traits\Addons\ListingItem;
use RtclElb\Helpers\Fns;

Class StoreName extends \ET_Builder_Module {
	use ListingItem;
	public $slug = 'rtcl_listing_store_name';
	...
	public function init() {
		$this->name      = esc_html__( 'Store Name', 'rtcl-elementor-builder' );
	...
	public function get_fields() {
		return [
			'__get_listing'           => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'RtclElb\DiviModule\Store\StoreName\StoreName', 'get_listing_title' ),
	...
	public static function get_listing_title(  $settings ) {
		$template_style = 'divi/store-single/name';
		$data = [
	...
	public function get_advanced_fields_config() {
		...
		$advanced_fields['fonts'] = [
			'title'       => [
				'css'              => array(
					'main' => '%%order_class%% .store-content-wrap .store-name > h2',
				),
				'important'        => 'all',
				'tab_slug'         => 'advanced',
				'toggle_slug'      => 'title',
