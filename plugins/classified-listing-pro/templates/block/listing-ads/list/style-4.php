						...
						<div class="right-content">
							...
							<?php if ( $instance['content_visibility']["phone_btn"] && ! empty( $the_loop['phone'] ) ) : ?>
								<div class="rtcl-phn rtcl-gb-button">
									<a class="rtcl-gb-phone-reveal rtcl-phone-reveal not-revealed" href="#"
									   data-phone="<?php echo esc_html( $the_loop['phone'] ); ?>">
										<i class="rtcl-icon-phone"></i><span><?php echo __( "Show Phone No", "classified-listing-pro" ); ?></span>
									</a>
								</div>
							<?php endif; ?>
