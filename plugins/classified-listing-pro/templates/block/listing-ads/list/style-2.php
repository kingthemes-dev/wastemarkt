						...
						<?php if ( $instance['content_visibility']["thumbnail"] && ! empty( $the_loop['thumbnail'] ) ) : ?>
							<div class="listing-thumb">
								<div class="listing-thumb-inner">
									...
									<?php endif; ?>
									<div
										class="rtcl-show-lg rtcl-gb-meta-buttons-wrap <?php echo esc_attr( $instance['content_visibility']["actionLayout"] ); ?> meta-button-count-3">
								...
								<div
									class="rtcl-show-sm rtcl-gb-meta-buttons-wrap <?php echo esc_attr( $instance['content_visibility']["actionLayout"] ); ?> meta-button-count-3">
									<?php if ( $instance['content_visibility']["favourit_btn"] && ! empty( $the_loop['favourite_link'] ) ) : ?>
										<div class="rtcl-gb-button"><?php echo wp_kses_post( $the_loop['favourite_link'] ); ?></div>
									<?php endif; ?>
							...
							<div class="item-content">
								...
								<ul class="rtcl-listing-meta-data">
									<?php if ( $instance['content_visibility']['listing_type'] && ! empty( $the_loop['listing_type'] ) ) : ?>
										<li class="listing-type"><i class="rtcl-icon rtcl-icon-tags"></i><?php echo esc_html( $the_loop['listing_type'] ); ?>
										</li>
									<?php endif; ?>
									...
									<?php if ( $instance['content_visibility']['view'] && ! empty( $the_loop['views'] ) ) : ?>
										<li class="rt-view"><i
												class="rtcl-icon rtcl-icon-eye"></i><?php echo esc_html( $the_loop['views'] ); ?> <?php echo __( " views",
												"classified-listing-pro" ); ?></li>
									<?php endif; ?>
								</ul>
								...
								<?php if ( $instance['content_visibility']['content'] && ! empty( $the_loop['excerpt'] ) ) : ?>
									<?php if ( $instance['content_limit'] && ! empty( $the_loop['excerpt'] ) ) { ?>
										<p class="rtcl-excerpt"><?php echo wp_trim_words( wpautop( $the_loop['excerpt'] ), $instance['content_limit'],
												'' ); ?></p>
									<?php } ?>
								<?php endif; ?>
								...
								<ul class="rtcl-listing-meta-data">
									...
									<?php if ( $instance['content_visibility']["view"] && ! empty( $the_loop['views'] ) ) : ?>
										<li class="rt-views">
											...
											echo __( " views", "classified-listing-pro" ); ?>
										</li>
									<?php endif; ?>
								</ul>
								<?php if ( $instance['content_visibility']['details_btn'] && ! empty( $the_loop['post_link'] ) ) : ?>
									<div class="rtcl-details"><a href=<?php echo esc_url( $the_loop['post_link'] ); ?>><?php echo __( "Details",
												"classified-listing-pro" ); ?></a></div>
								<?php endif; ?>
							</div>
						</div>
