...
<form method="post" id="rtcl-password-reset-form" class="rtcl-lost-reset-password">
    ...
    <div class="rtcl-form-group">
        ...
        <input type="password" name="password_1" id="password-1" class="rtcl-form-control rtcl-password" autocomplete="new-password"
               required/>
    </div>
    ...
    <div class="rtcl-form-group">
        ...
        <input type="password" name="password_2" id="password-2" class="rtcl-form-control" autocomplete="new-password"
