...
<div <?php Functions::listing_class( [ 'rtcl-widget-listing-item', $item_class, 'listing-item', $img_position_class ] ); ?>>
	...
	if ( $phone && $instance['rtcl_show_phone'] ) :
		...
		<div class="rtin-phn rtin-el-button">
			<a class="rtcl-phone-reveal not-revealed" href="#"
			   data-phone="<?php echo esc_attr( $phone ); ?>"><i class="rtcl-icon rtcl-icon-phone"
																 aria-hidden="true"></i><span><?php esc_html_e( 'Show Phone No',
						'rtcl-elementor-builder' ); ?></span></a>
		</div>
	<?php endif; ?>
	...
	Rtcl\Helpers\Functions::print_html( $final_contents, true );
	?>
