...
<div <?php Functions::listing_class(['rtcl-widget-listing-item', $item_class, 'listing-item', $img_position_class]); ?>>
	...
	ob_start();
	?>
	<?php if (Functions::is_enable_favourite() || $instance['contentVisibility']['author']) : ?>
		<div class="rtin-bottom <?php echo !empty($instance['contentVisibility']['author']) ? 'has-author' : ''; ?>">
			<ul>
				<?php if ($instance['contentVisibility']['author']) : ?>
				...
				?>
						<li class="action-btn">
							...
							?>
							<a class="rtcl-compare <?php echo esc_attr($selected_class); ?>" href="#" title="<?php esc_attr_e('Compare', 'rtcl-elementor-builder'); ?>" data-listing_id="<?php echo absint($_id); ?>"><i class="rtcl-icon rtcl-icon-retweet"></i>
							</a>
						</li>
				<?php
					endif;
