...
class ListingDescription extends BlockBase
{
	use Singleton;
	...
	public function block_attributes()
	{
		...
		return apply_filters('rtcl_listing_description_block_attributes', $attributes);
	}

	public function register_block()
	{
		register_block_type(
			RTCL_ELB_PATH . 'app/Blocks/listing-description',
			[
	...
	{
		$template_style = 'listing-single/listing-description';
		$data = [
		...
		$data = apply_filters('rtcl_block_listing_description_data', $data);
		ob_start();
