...
class StoreDescription extends SingleStroeBlockBase
{
	use Singleton;
	...
	public function block_attributes()
	{
		...
		return apply_filters('rtcl_store_description_block_attributes', $attributes);
	}

	public function register_block()
	{
		register_block_type(
			RTCL_ELB_PATH . 'app/Blocks/store-description',
			[
	...
	public function render_block($attributes)
	{
		...
		$data = apply_filters('rtcl_block_store_description_data', $data);
		ob_start();
