...
namespace  RtclElb\DiviModule\ListingVideo;
use Rtcl\Helpers\Functions;
use Rtcl\Traits\Addons\ListingItem;
use RtclElb\Helpers\Fns;

Class ListingVideo extends \ET_Builder_Module {
	use ListingItem;
	public $slug = 'rtcl_listing_video';
	...
	public function init() {
		$this->name      = esc_html__( 'Listing Video', 'rtcl-elementor-builder' );
	...
	public function get_fields() {
		return [
			...
			'__get_video'           => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'RtclElb\DiviModule\ListingVideo\ListingVideo', 'get_listing_video' ),
	...
	public static function get_the_video() {
		$data       = [
			'videos' => [],
		];
		$video_urls = [];
	...
	public static function get_listing_video(  $settings ) {
		$template_style = 'divi/listing-video/video';
		$data = [
	...
	public function render( $unprocessed_props, $content, $render_slug ) {
		...
		return self::get_listing_video( $settings );
	}
