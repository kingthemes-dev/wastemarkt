    ...
    <div class="hmwp_row d-flex flex-row p-0 m-0">
        <div class="hmwp_col flex-grow-1 p-0 pr-2 mr-2 mb-3">
            ...
            <form method="POST">
                ...
                <div id="redirects" class="col-sm-12p-0 m-0 tab-panel tab-panel-first">
                                    ...
                                    <div class="tab-pane show active" id="default" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="col-sm-12 row border-bottom border-light py-3 m-0">
                                            <div class="col-sm-4 p-0 py-2 font-weight-bold">
                                                ...
                                                <div class="small text-black-50"><?php echo esc_html__( "eg.", 'hide-my-wp' ) . ' ' . esc_url(admin_url( '', 'relative' )); ?></div>
                                            </div>
                                        ...
                                        <div class="col-sm-12 row border-bottom border-light py-3 mx-0">
                                            <div class="col-sm-4 p-0 py-2 font-weight-bold">
                                                ...
                                                <div class="small text-black-50"><?php echo esc_html__( "eg. /logout or", 'hide-my-wp' ) . ' ' . esc_url(home_url( '', 'relative' )); ?></div>
                                            </div>
                                            <div class="col-sm-8 p-0 input-group">
                ...
                <div id="sitemap" class="col-sm-12p-0 m-0 tab-panel">
                    <div class="card col-sm-12 p-0 m-0">
                                ...
                                <div class="col-sm-12 row mb-1 ml-1 p-2">
                                    <div class="checker col-sm-12 row my-2 py-1">
                                        <div class="col-sm-12 p-0 switch switch-sm">
                                            ...
                                            <div class="text-black-50 ml-5"><?php echo sprintf( esc_html__( 'Check the %s RSS feed %s and make sure the image paths are changed.', 'hide-my-wp' ), '<a href="' . esc_url(site_url() . '/rss') . '" target="_blank"><strong>', '</strong></a>' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 row mb-1 ml-1 p-2">
                                    <div class="checker col-sm-12 row my-2 py-1">
                                        <div class="col-sm-12 p-0 switch switch-sm">
                                            ...
                                            <div class="text-black-50 ml-5"><?php echo sprintf( esc_html__( 'Check the %s Sitemap XML %s and make sure the image paths are changed.', 'hide-my-wp' ), '<a href="' . esc_url(site_url() . '/sitemap.xml') . '" target="_blank"><strong>', '</strong></a>' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 row mb-1 ml-1 p-2">
                                    <div class="checker col-sm-12 row my-2 py-1">
                                        <div class="col-sm-12 p-0 switch switch-sm">
                                            ...
                                            <div class="text-black-50 ml-5"><?php echo sprintf( esc_html__( 'Hide WordPress common paths from %s Robots.txt %s file.', 'hide-my-wp' ), '<a href="' . esc_url(site_url() . '/robots.txt') . '" target="_blank"><strong>', '</strong></a>' ); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="changes" class="col-sm-12p-0 m-0 tab-panel">
                    <div class="card col-sm-12 p-0 m-0">
                                ...
                                <div class="col-sm-12 row mb-1 ml-1 p-2">
                                    <div class="checker col-sm-12 row my-2 py-1">
                                        <div class="col-sm-12 p-0 switch switch-sm">
                                            ...
                                            <div class="text-black-50 ml-5"><?php echo sprintf( esc_html__( 'Convert links like /wp-content/* into  %s/wp-content/*.', 'hide-my-wp' ), esc_url(site_url()) ); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="hide" class="col-sm-12p-0 m-0 tab-panel">
                    <div class="card col-sm-12 p-0 m-0">
                ...
                <div id="disable" class="col-sm-12p-0 m-0 tab-panel">
                    <div class="card col-sm-12 p-0 m-0">
