(function ($) {
    ...
    $.fn.hmwp_fixPrefix = function (value) {
        var $form = $('#hmwp_fixprefix_form');
        var $this = this;
    ...
    $.fn.hmwp_fixPermissions = function () {
        var $form = $('#hmwp_fixpermissions_form');
        var $this = this;

        $this.hmwp_loading(true);
        //hide fix button
        $('#fixcheckFilePermissions').hide();

        $.post(
            ajaxurl,
            {
                action: $form.find('input[name=action]').val(),
                value: $form.find('input[name=value]:checked').val(),
                hmwp_nonce: $form.find('input[name=hmwp_nonce]').val(),
                _wp_http_referer: $form.find('input[name=_wp_http_referer]').val()
            }
        ).done(
            function (response) {
                $('#hmwp_fixpermissions_modal').modal('hide');
                $this.hmwp_loading(false);
    ...
    $.fn.hmwp_fixSalts = function (value) {
        var $form = $('#hmwp_fixsalts_form');
        var $this = this;
    ...
    $.fn.hmwp_fixAdmin = function () {
        var $form = $('#hmwp_fixadmin_form');
        var $this = this;
        ...
        $.post(
            ...
            {
                action: $form.find('input[name=action]').val(),
                name: $form.find('input[name=hmwp_username]').val(),
                hmwp_nonce: $form.find('input[name=hmwp_nonce]').val(),
                _wp_http_referer: $form.find('input[name=_wp_http_referer]').val()
            }
        ).done(
            function (response) {
                $('#hmwp_fixadmin_modal').modal('hide');
                $this.hmwp_loading(false);
    ...
    $.fn.hmwp_fixUpgrade = function () {
        var $form = $('#hmwp_fixupgrade_form');
        var $this = this;
    ...
    $.fn.hmwp_settingsListen = function () {
        ...
        $('#hmwp_geoblock_selectall').click(function () {
            if($(this).is(':checked')){
