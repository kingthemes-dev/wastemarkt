...
class HMWP_Models_ListTable extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct( array( 'singular' => esc_html__( 'log', 'hide-my-wp' ),     //singular name of the listed records
	...
	public function table_head() {
		...
		echo '.wp-list-table .column-ip { width: 25%; }';
		echo '.wp-list-table .column-data { width: 38%;}';
		echo '.wp-list-table .column-datetime { width: 25%;}';
		echo '</style>';
	...
	public function get_sortable_columns() {
		...
		return array( 'logaction' => array( 'logaction', false ), 'ip' => array( 'ip', false ), 'datetime' => array( 'datetime', false ) );

	}

	public function get_columns() {

		return array( 'logaction' => esc_html__( 'User Action', 'hide-my-wp' ), 'ip' => esc_html__( 'Location', 'hide-my-wp' ), 'data' => esc_html__( 'Details', 'hide-my-wp' ), 'datetime' => esc_html__( 'Date', 'hide-my-wp' ) );
