...
class RtclApplyHook {
	...
	static function init() {
		...
		remove_action( 'rtcl_payment_receipt_popup', [ TemplateHooks::class, 'payment_receipt_popup_pricing_info' ], 20 );
	...
	public static function update_store_id_as_owner_for_manager_post( $post_arg, $type ) {
		...
		if ( $type === 'new' && $current_user_id && isset( $post_arg['post_author'] ) && absint( $post_arg['post_author'] )
		     && ( $store
