...
<div class="rtcl rtcl-store-search rtcl-store-search-inline">
    <form action="<?php echo esc_url(get_permalink(Functions::get_page_id('store'))); ?>"
        ...
        <div class="reset-submit-btn">
            <button type="submit" class="rtcl-btn rtcl-btn-primary submit-btn"><?php esc_html_e('Search Store', 'classified-listing-store'); ?></button>
            <a href="<?php echo esc_url(strtok($_SERVER["REQUEST_URI"], '?')) ?>" class="rtcl-btn rtcl-btn-danger reset-btn">
