			...
			foreach ( $sorted as $box_context => $ids ) {
				foreach ( explode( ',', $ids ) as $id ) {
					if ( $id == 'hmwp_securitycheck_widget' ) {
						?>
                        <div id="hmwp_securitycheck_widget" class="card col-sm-12 p-0 m-0 mb-3 border-0 bg-white postbox <?php echo esc_attr(postbox_classes( 'hmwp_securitycheck_widget', $page )) ?>">
                        ...
                        <div id="hmwp_features_widget"
                             class="card col-sm-12 p-0 m-0 mb-3 border-0 bg-white postbox <?php echo esc_attr(postbox_classes( 'hmwp_features_widget', $page )) ?>">
                            <div class="postbox-header hmwp_header">
