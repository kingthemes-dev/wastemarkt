...
$previous_text = '<i class="fa fa-angle-double-left" aria-hidden="true"></i>' . esc_html__( 'Previous', 'classilist' );
$next_text     = esc_html__( 'Next', 'classilist' ) . '<i class="fa fa-angle-double-right" aria-hidden="true"></i>';

echo '<div class="pagination-area elementwidth elwidth-680 elwidth-480"><ul class="clearfix">' . "\n";
