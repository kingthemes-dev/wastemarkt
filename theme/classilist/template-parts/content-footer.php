						...
						<div class="col-md-4 col-sm-12 col-12">
							<ul class="payment-icons">
								<?php if ( RDTheme::$options['payment_img'] ) : ?>
									...
									<?php endforeach; ?>
								<?php else: ?>
									<li><img alt="payment" src="<?php echo URI_Helper::get_img( 'payment-method1.jpg' ); ?>"></li>
									<li><img alt="payment" src="<?php echo URI_Helper::get_img( 'payment-method2.jpg' ); ?>"></li>
									<li><img alt="payment" src="<?php echo URI_Helper::get_img( 'payment-method3.jpg' ); ?>"></li>
									<li><img alt="payment" src="<?php echo URI_Helper::get_img( 'payment-method4.jpg' ); ?>"></li>
								<?php endif; ?>
							</ul>
						</div>
					<?php endif; ?>
