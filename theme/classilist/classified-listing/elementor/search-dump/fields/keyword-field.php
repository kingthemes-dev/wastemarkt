...
<div class="form-group rt-autocomplete-wrapper rtcl-flex rtcl-flex-column elementor-repeater-item-<?php echo esc_attr( $repeater_id ); ?>">
	...
	<div class="keywords-field-wrapper">
		<input type="text" name="q" data-type="listing" class="rtcl-autocomplete form-control" placeholder="<?php esc_attr_e( 'Enter your keyword here ...', 'classilist' ); ?>" value="<?php echo esc_html( $keywords ); ?>">
	</div>
</div>